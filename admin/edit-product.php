...
//<?php
//get the value from form and save it in database
//check whether the submit button clicked or not(Button clicked or not)
if(isset($_POST['submit'])){
   ...
   $Units_In_Stock =$_POST['Units In Stock'];
